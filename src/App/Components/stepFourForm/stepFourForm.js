...
export default function StepFourForm() {
   ...
   useEffect(()=>{
        formData.__setFormData({...formData.__formData, registrationStage: 3})
   },[]);
...
<form className="row g-3">
    ...
    <div className='regFormNavControl'>
        <div></div>
        <Link className='btn btn-primary btn-next-nav' to="/step3">Previous</Link>
        <a className='btn btn-primary btn-next-nav' href="javascript:void(0)">Submit</a>
    </div>
</div>
  )
}
