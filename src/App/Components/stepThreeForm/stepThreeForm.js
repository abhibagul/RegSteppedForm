...
export default function StepThreeForm() {
   ...
   useEffect(()=>{
        formData.__setFormData({...formData.__formData, registrationStage: 2})
   },[]);
...
<form className="row g-3">
    ...
    <div className='regFormNavControl'>
        <div></div>
        <Link className='btn btn-primary btn-next-nav' to="/step2">Previous</Link>
        <Link className='btn btn-primary btn-next-nav' to="/step4">Next</Link>
    </div>
</div>
  )
}
